...
export function Buts(props) {
    ...
    const { id } = useParams()
    const butData = buts?.filter((b) => b.matche_id === parseInt(id));

    console.log(butData)
    const addState = () =>{
        if (butData) {
            setButUpdate([...butData]);
        }
    }
                                    ...
                                    <div className="form-group col-md-3">
                                        ...
                                        <div className='my-2'>
                                            <CreatableSelect className='text-light'
                                                ...
                                                options={optionsJ}
                                                value={state?.joueurs.find((j) => j.licence === item?.joueur_numero_licence)}
