...
class PasswordResetRequestController extends Controller
{
    ...
    public function failedResponse()
    {
        return response()->json([
            'error' => 'لم يتم العثور على البريد الإلكتروني في قاعدة البيانات الخاصة بنا'
    ...
    {
        return response()->json([
            'data' => 'لقد أرسلنا عبر البريد الإلكتروني رابط إعادة تعيين كلمة المرور الخاصة بك . تفحص بريدك'
        ], Response::HTTP_OK);
    }
}
